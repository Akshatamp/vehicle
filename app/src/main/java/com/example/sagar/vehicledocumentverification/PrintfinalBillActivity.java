...
public class PrintfinalBillActivity extends AppCompatActivity {
    ...
    String string_pcode,string_pname,string_qty,string_price,string_amount,string_grand;
    String s1,s2,s3,s4,s5,s6;
    Button btn_print_take;
    String sr;
    int mrandomnumber;
    String s;

    LinearLayout LinearLayoutView;
    String string_mno,stringname,stringaddress,stringet_pdetails,stringet_amount ;
...
Double twoDigitsumsgst,twoDigitsumcgst,twoDigitsumigst,twoDigitsumintra,twoDigitsuminter,twoidigistsum_amt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printfinalbill);
        sharedPrefHandler=new SharedPrefHandler(this);

        string_mno=sharedPrefHandler.getSharedPreferences("mno");
        stringname=sharedPrefHandler.getSharedPreferences("name");
        stringaddress=sharedPrefHandler.getSharedPreferences("address");


        stringet_pdetails=sharedPrefHandler.getSharedPreferences("pd");
        stringet_amount=sharedPrefHandler.getSharedPreferences("amt");
       ...
       // input_id=sharedPrefHandler.getSharedPreferences("lid");
        ...
        textView1.setText(stringet_pdetails);
        textView2.setText(stringet_amount);
...
//
                ...
                createPdfwithoutgst(string_mno,stringname,stringaddress);
...
//    private void getCartItems(String string_mno) {
...
//
//        Call<List<Cart>> call = api.getCartByCode(string_mno);
//
...
//                int slno=1;
//                if(isSuccess) {
//                    textViewid.append(slno+"\n\n");
//                    textView1.setText(cartItemList.get(0).getstringet_pdetails());
//                    textView2.setText(cartItemList.get(0).getstringet_amount());
//
//                    slno++;
//
//                } else {
...
//
    ...
    private void createPdfwithoutgst(String string_mno,String stringname,String stringaddress)
    {
        ...
        if (checkPermission()) {
            ...
            canvas.drawText("(O) : 9449045383", 420, 20, paint);
...
//            canvas.drawText("CASH MEMO", 220, 50, paint);
           ...
           // String invoi=dated+sr;
            ...
            paint.setTypeface(Typeface.create("Arial", Typeface.BOLD));
            // paint.setTypeface(bold);
            canvas.drawText("VEHICLE  RTO DEPARTMENT", 160, 70, paint);
            paint.setColor(Color.BLACK);
            paint.setTextSize(7);
           ...
           // canvas.drawText("No.  " + invoi, 10, 100, paint);
            ...
            canvas.drawText("User Name, " + stringname, 10, 120, paint);
           // canvas.drawText("Payment Status  :  " + payment1, 350, 130, paint);

            canvas.drawText("Mobile No :    " + string_mno, 10, 140, paint);
            // canvas.drawText("HSN Code : " + hsnCode1, 180, 130, paint);
            //canvas.drawText("Party GSTIN :  " + custGst1, 10, 140, paint);
...
//            canvas.drawLine(390, 470, 695, 470, paint);
            ...
            canvas.drawText("To R.T.O ", 350, 530, paint);
